"""Configuration templates and push utilities for network switches."""
...
""",
            "parameters": {
                ...
                "description": {"type": "string", "default": "Access Port", "label": "Port Description"},
...
""",
            "parameters": {
                ...
                "priority": {"type": "select", "options": ["0", "4096", "8192", "12288", "16384", "20480", "24576", "28672"], "default": "24576", "label": "Bridge Priority"},
            }
        },
        "snmp_config": {
...
def get_templates_for_vendor(vendor: str) -> dict[str, Any]:
    """Get all configuration templates for a vendor."""
    return CONFIG_TEMPLATES.get(vendor, {})

def get_template(vendor: str, template_name: str) -> dict[str, Any] | None:
    """Get a specific configuration template."""
    templates = get_templates_for_vendor(vendor)
    return templates.get(template_name)

def render_template(vendor: str, template_name: str, parameters: dict[str, str]) -> str | None:
...
def get_template_list(vendor: str) -> list[dict[str, str]]:
